...
<!-- Mirrored from demo.ravelweb.com/material-cv/home.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 13 Nov 2016 17:50:10 GMT -->
...
<head>
    ...
    <!-- Google Font -->
    <link href='fonts.googleapis.com/css7b4f?family=Roboto' rel='stylesheet'>


    <!-- Google Material Icon -->
    <link href="fonts.googleapis.com/icone91f?family=Material+Icons" rel="stylesheet">
    <!-- Font Awesome Icon -->
    ...
    <link id="color-switcher" href="stylesheets/style.css" rel="stylesheet">
...
<div id="page-loader">
    ...
    <div class="text-div text-center animated zoomIn">
        ...
        <!-- Name Only -->
        <h6 class="text-uppercase">MAHESH TAHILRAMANI</h6>
    </div>
</div>
...
<div id="header" class="shadow">
                ...
                <div id="side-nav">
                    <div id="nav-header">
                        <div id="nav-profile" class="center-block">
                            ...
                            <img src="G:\My Pic\DSC_0179.jpg">
                        </div>
                        <h6 class="text-center text-capitalize">Mahesh Tahilramani</h6>
                    </div>
    ...
    <div id="intro" class="container">
        <h1 class="text-center text-capitalize">Mahesh Tahilramani</h1>
        <h4 class="text-center text-capitalize">Java Developer</h4>
    </div>
</div>
                ...
                <div id="intro-div" class="card content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col col-xs-12 col-sm-12 col-md-12 text-center">
                            <!-- Your CV File -->
                            <a href="G:\MyResume\Mahesh_Resume.pdf" download="G:\MyResume\Mahesh_Resume.pdf" class="btn waves-effect waves-light btn-primary custom-btn">Download CV</a>
                        ...
                        <li class="card" data-aos="fade-up">
                            ...
                            <div class="timeline-content">
                                ...
                                <div class="timeline-header">
                                    <h3 class="text-capitalize">Software Developer</h3>
                                </div>

                                <!-- Organization and Period -->
                                <p class="sub-heading">Primavera Systems Pvt Ltd, Vadodara</p>
                                <p class="sub-heading">March 2016 - Present</p>

                                <!-- Job Summary -->
                                <p class="content-p">
                                    Provide ongoing application support and troubleshooting. Created a demo application using JSP and Servlets which displayed social profile data by entering multiple email ids in a textbox. Have high proficiency in tools like MySQL Workbench, TIBCO Jaspersoft Studio Pro and TIBCO Jasper Server Pro.
                                </p>
                            </div>
                        </li>
        ...
        <div class="row">
            ...
            <div class="col col-md-4 col-sm-4 col-xs-12">
                <div class="card content-wrapper skill-wrapper">
                    ...
                    <div class="skill-progress-div">
                        <!-- Add Skill -->
                        <p>Java Web Application<span>90%</span></p>
                        <!-- Edit Value Here -->
                    ...
                    <div class="skill-progress-div">
                        <!-- Add Skill -->
                        <p>TIBCO Jaspersoft Studio<span>90%</span></p>
                        <!-- Edit Value Here -->
            ...
            <div class="col col-md-4 col-sm-4 col-xs-12">
                <div class="card content-wrapper skill-wrapper">
                    ...
                    <div class="skill-progress-div">
                        <!-- Add Skill -->
                        <p>Sindhi (Native)<span>70%</span></p>
                        <!-- Edit Value Here -->
                        <div class="progress skill-progress" data-percent="70%">
                            <div class="determinate skill-determinate">
                                <i class="skill-determinate-circle fa fa-circle"
                    ...
                    <ul>
                        <li class="card" data-aos="fade-up">
                            ...
                            <div class="timeline-content">
                                ...
                                <p class="sub-heading">College: Babaria Institute Of Technology, Vadodara</p>
								<p class="sub-heading">University: Gujarat Technological University(G.T.U)</p>
                                <p class="sub-heading">Term: July 2012 - May 2016</p>
                                <p class="sub-heading">Result: 7.53 CGPA</p>
                        ...
                        <li class="card" data-aos="fade-up">
                            ...
                            <div class="timeline-content">
                                ...
                                <!-- Heading -->
                                <div class="timeline-header">
                                    <h3 class="text-capitalize">Higher Secondary Certificate (H.S.C)</h3>
                                </div>

                                <!-- Institution, Period & result -->
                                <p class="sub-heading">School: Shree Satya Sai Vidyalaya</p>
								<p class="sub-heading">Board: Gujarat Secondary and Higher Secondary Education Board (G.S.E.B)</p>
                                <p class="sub-heading">Passing Year: 2012</p>
                                <p class="sub-heading">Result: 65%</p>
                        ...
                        <li class="card" data-aos="fade-up">
                            ...
                            <div class="timeline-content">
                                ...
                                <!-- Heading -->
                                <div class="timeline-header">
                                    <h3 class="text-capitalize">Secondary Certificate (S.S.C)</h3>
                                </div>

                                <!-- Institution, Period & result -->
                                <p class="sub-heading">School: Shree Satya Sai Vidyalaya</p>
								<p class="sub-heading">Board: Gujarat Secondary and Higher Secondary Education Board (G.S.E.B)</p>
                                <p class="sub-heading">Passing Year: 2010</p>
                                <p class="sub-heading">Result: 80%</p>
...
<section id="pricing" class="section">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <ul class="text-center period-btn">
                <li id="month-btn" class="active-cat"><a>Monthly</a></li>
                <li id="year-btn"><a>Yearly</a></li>
            </ul>

            <!-- Monthly Pricing -->
            <div id="month" class="col col-md-12 col-sm-12 col-xs-12 period-type">
                <div class="row">
                    ...
                    <!-- Silver -->
                    <div class="col col-md-3 col-sm-6 col-xs-12">
                        <div class="card pricing-table" data-aos="fade-up" data-aos-delay="450">
                            <!-- Table Name -->
                    ...
                    <!-- Gold -->
                    <div class="col col-md-3 col-sm-6 col-xs-12">
                        <div class="card pricing-table" data-aos="fade-up" data-aos-delay="600">
                            <!-- Table Name -->
                    ...
                    <!-- Platinum -->
                    <div class="col col-md-3 col-sm-6 col-xs-12">
                        <div class="card pricing-table" data-aos="fade-up" data-aos-delay="750">
                            <!-- Table Name -->
            ...
            <!-- Yearly Pricing -->
            <div id="year" class="col col-md-12 col-sm-12 col-xs-12 period-type">
                <div class="row">
...
<script src="javascript/custom-map.js"></script>
